...
class ProductView(View):
  def get(self,request):
    glasses = Product.objects.filter(category="G")
    hats = Product.objects.filter(category="H")
    shirt = Product.objects.filter(category="S")
    return render(request, 'app/home.html',{'glasses':glasses,'hats':hats,'shirt':shirt})
...
class CustomerRegistrationView(View):
    ...
    def post(self,request):
        ...
        if form.is_valid():
            messages.success(request, 'Congratulations!! Successfully Register')
